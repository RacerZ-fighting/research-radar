...
class LLMRelevancePipelineTestCase(unittest.TestCase):
    ...
    def test_parse_score_response_extracts_fenced_json_from_preface(self) -> None:
        ...
        raw_response = """**Refining Research Focus**

Some prefatory text that should be ignored.

```json
{"score": 4, "reason": "Highly related to web security."}
```"""

        self.assertEqual(pipeline._parse_score_response(raw_response), 4)
