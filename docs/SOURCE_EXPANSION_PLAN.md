...
- 可抓取：PortSwigger、OpenAI Blog、Anthropic News、Brutecat、HackTron AI、Trail of Bits、Google Online Security Blog、GitHub Blog Security、Assetnote Research、Bishop Fox Blog、Synacktiv Publications、Govuln Sec-News、BSidesSF（AllBSides recording fallback）
- 聚合源：Govuln Sec-News 是安全文摘/聚合 feed，噪声可能高于一手研究博客，默认依赖 LLM 相关度过滤控制展示
