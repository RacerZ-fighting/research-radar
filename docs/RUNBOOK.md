...
OpenAI / Anthropic / Brutecat / HackTron / Trail of Bits / Google Online Security Blog / GitHub Blog Security / Assetnote / Bishop Fox / Synacktiv / Govuln Sec-News / Black Hat / DEF CON / BSidesSF 等已进入集中配置。
...
- 可抓取：OpenAI Blog、Anthropic News、Brutecat、HackTron AI、Trail of Bits、Google Online Security Blog、GitHub Blog Security、Assetnote Research、Bishop Fox Blog、Synacktiv Publications、Govuln Sec-News、DEF CON、BSidesSF（AllBSides recording fallback）、PortSwigger
...
python -m src.cli crawl --source synacktiv-publications
python -m src.cli crawl --source govuln-news
```
